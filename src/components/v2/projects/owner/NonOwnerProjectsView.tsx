// Phase 3.5 / Plan 03.5-01 — verbatim extraction of the pre-refactor
// /projects tile-list path. Renders for member + viewer roles. Owners
// take a different branch via the page role-router in
// src/app/projects/page.tsx → OwnerWorkloadBoard.
//
// All hooks + JSX + styling are byte-equivalent to the pre-refactor
// V2ProjectsListPage. The only change is the component name + the fact
// that it lives in its own file instead of the page module.
...
export default function NonOwnerProjectsView() {
  const ctx = useTeam();
