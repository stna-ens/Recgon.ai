...
const MediaBackground = ({ isTikTok }: { isTikTok: boolean }) => (
  <div style={{
...
// ── TikTok UI Chrome ──
const TikTokChrome = ({
  brandName, handle, caption, captionPreview, captionExpanded, setCaptionExpanded, hashtags,
}: ChromeProps & { handle: string }) => (
  <>
    <div style={{
...
const InstagramChrome = ({
  brandName, caption, captionPreview, captionExpanded, setCaptionExpanded, hashtags,
}: ChromeProps) => (
  <>
    <div style={{
      position: 'absolute', top: 50, left: 0, right: 0, padding: '0 16px',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 24 }}>
      <div style={{
        ...
        <div style={{ position: 'relative', aspectRatio: '9/19.5', overflow: 'hidden', background: '#000' }}>
          <MediaBackground isTikTok={isTikTok} />
          {isTikTok ? <TikTokChrome {...chromeProps} handle={handle} /> : <InstagramChrome {...chromeProps} />}
        </div>
      </div>
