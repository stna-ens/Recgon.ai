...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const update = () => setCardHeight(Math.max(360, Math.min(window.innerHeight - 260, 1100)));
    update();
  ...
  return (
    <div>
      ...
      {/* Chat */}
      <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', height: cardHeight, padding: 0, overflow: 'hidden', marginBottom: 24, fontFamily: "'JetBrains Mono', ui-monospace, monospace", position: 'relative' }}>
