...
export const getProjectDetailsTool: ToolDefinition<Input, Record<string, unknown>> = {
  ...
  description:
    'Fetch full stored data for ONE project — campaigns and marketing content. Always pass the project name in the `project` argument. Use when the user asks to see existing campaigns or content for a specific project.',
  parameters,
